...
CPPFLAGS=-DSTM32F401xE \
 ...
 -I/home/jstifter/code/embedded/stm32/autonomous_drone/src/drivers
...
#else ifeq ($(TEST), motor_test)
# SOURCE_FILE = src/tests/motor_test.c
#else ifeq ($(TEST), sensor_test)
# SOURCE_FILE = src/tests/sensor_test.c
#else ifeq ($(TEST), start_stop_test)
# SOURCE_FILE = src/tests/start_stop_test.c
#else
# SOURCE_FILE = main.c
#endif
###
