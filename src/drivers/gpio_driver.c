...
{
    [MOTOR_0] =  {IO_MODE_AF, IO_OTYPE_PUSH_PULL, IO_OSPEED_HIGH, IO_RESISTOR_NONE, IO_OUTPUT_LOW},
    [MOTOR_1] =  {IO_MODE_AF, IO_OTYPE_PUSH_PULL, IO_OSPEED_HIGH, IO_RESISTOR_NONE, IO_OUTPUT_LOW},
    [IO_UNUSED_2] = UNUSED_CONFIG,
    [MOTOR_3] =  {IO_MODE_AF, IO_OTYPE_PUSH_PULL, IO_OSPEED_HIGH, IO_RESISTOR_NONE, IO_OUTPUT_LOW},
    ...
    [MOTOR_2] = {IO_MODE_AF, IO_OTYPE_PUSH_PULL, IO_OSPEED_HIGH, IO_RESISTOR_NONE, IO_OUTPUT_LOW},
